      ...
      <table class="providerTable" cellpadding="0" cellspacing="0">
          ...
          <c:forEach var="bill" items="${billList }" varStatus="status">
				<tr>
					...
					<td>
					<span><a class="viewBill" href="/sys/bill/view?billid=${bill.id }"  billcc=${bill.billCode }><img src="${pageContext.request.contextPath }/statics/images/read.png" alt="查看" title="查看"/></a></span>
					<%--<span><a class="modifyBill" href="javascript:;" billid=${bill.id } billcc=${bill.billCode }><img src="${pageContext.request.contextPath }/statics/images/xiugai.png" alt="修改" title="修改"/></a></span>--%>
                        <span><a class="modifyBill" href="/sys/bill/billById?billId=${bill.id }"  billcc=${bill.billCode }><img src="${pageContext.request.contextPath }/statics/images/xiugai.png" alt="修改" title="修改"/></a></span>
