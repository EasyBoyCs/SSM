...
<div class="right">
        ...
        <div class="search">
        	<form method="post" action="${pageContext.request.contextPath }/sys/provider/list.html">
				...
				<a href="${pageContext.request.contextPath }/sys/provider/addPro">添加供应商</a>
			</form>
        </div>
        <!--供应商操作表格-->
        <table class="providerTable" cellpadding="0" cellspacing="0">
            ...
            <c:forEach var="provider" items="${providerList }" varStatus="status">
				<tr>
					...
					<td>
					<span><a class="viewProvider" href="/sys/provider/view?proid=${provider.id }"  proname=${provider.proName }><img src="${pageContext.request.contextPath }/statics/images/read.png" alt="查看" title="查看"/></a></span>
					<span><a class="modifyProvider" href="/sys/provider/modify?proId=${provider.id }"proname=${provider.proName }><img src="${pageContext.request.contextPath }/statics/images/xiugai.png" alt="修改" title="修改"/></a></span>
