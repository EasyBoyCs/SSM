        ...
        <c:forEach var="user" items="${userList }" varStatus="status">
            <tr>
                ...
                <span><a class="viewUser" href="javascript:;" userid=${user.id } username=${user.userName }><img src="${pageContext.request.contextPath }/statics/images/read.png" alt="查看" title="查看"/></a></span>
                    ...
                    <span><a class="modifyUser" href="/sys/user/usermodify.html?userId=${user.id }" username=${user.userName }><img src="${pageContext.request.contextPath }/statics/images/xiugai.png" alt="修改" title="修改"/></a></span>
                    <span><a class="deleteUser" href="javascript:;" uid=${user.id } username=${user.userName }><img src="${pageContext.request.contextPath }/statics/images/schu.png" alt="删除" title="删除"/></a></span>
                        <%--<span><a class="deleteUser" href="/user/deUser/${user.id }"username=${user.userName }><img src="${pageContext.request.contextPath }/statics/images/schu.png" alt="删除" title="删除"/></a></span>--%>
                </td>
            </tr>
        </c:forEach>
    </table>
...
<div class="providerAdd">
    <h1 style="content: none">点击查看按钮!!!看用户信息</h1>
    <div>
        <label>用户编码：</label>
